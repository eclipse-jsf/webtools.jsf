...
public class DefaultBuiltInSymbolProvider
{
    ...
    private static final String APPLICATION_SCOPE                   =
        "applicationScope";                //$NON-NLS-1$
        private static final String SESSION_SCOPE                       =
            "sessionScope";                    //$NON-NLS-1$
            private static final String REQUEST_SCOPE                       =
                "requestScope";                    //$NON-NLS-1$
            private static final String COOKIE_IMPLICIT_OBJ                 = "cookie";                                //$NON-NLS-1$
            private static final String FACES_CONTEXT_IMPLICIT_OBJ          =
                "facesContext";                    //$NON-NLS-1$
            private static final String HEADER_IMPLICIT_OBJ                 = "header";                                //$NON-NLS-1$
            private static final String HEADER_VALUES_IMPLICIT_OBJ          =
                "headerValues";                    //$NON-NLS-1$
            private static final String INIT_PARAM_IMPLICIT_OBJ             =
                "initParam";                       //$NON-NLS-1$
            private static final String PARAM_IMPLICIT_OBJ                  = "param";                                 //$NON-NLS-1$
            private static final String PARAM_VALUES_IMPLICIT_OBJ           =
                "paramValues";                     //$NON-NLS-1$
             ...
             */
            public ISymbol[] getSymbols(final IAdaptable context, final int symbolScopeMask)
            {
                final IFile fileContext =
                    FileContextUtil.deriveIFileFromContext(context);
            ...
            {
                return SymbolUtil.findSymbolByName(
                        getSymbols(context, symbolScopeMask), name);
            }
            ...
            public ISymbol[] getSymbols(final String prefix, final IAdaptable context,
                    final int symbolScopeMask)
            {
                return SymbolUtil.filterSymbolsByPrefix(getSymbols(context,
                        symbolScopeMask), prefix);
            }
            ...
            private List getRequestScopeSymbols(final IFile file)
            {
                ...
                symbols.add(createScopeSymbol(file,
                ...
                symbols
                .add(createJavaInstanceSymbol(file.getProject(),
                        FACES_CONTEXT_FULLY_QUALIFIED_CLASS,
                        FACES_CONTEXT_IMPLICIT_OBJ));
                symbols.add(createJavaInstanceSymbol(file.getProject(),
            ...
            {
                return Collections.singletonList(createScopeSymbol(file,
                    ...
                    final String fullyQualifiedClass, final String symbolName)
            {
                ...
                try
                {
                    ...
                    if (type != null)
                    {
                        ...
                        final IBeanInstanceSymbol facesContextVar =
