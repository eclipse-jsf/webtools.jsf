...
public class FacesConfigExtensionTypeItemProvider
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/FacesConfigExtensionType"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ?
            getString("_UI_FacesConfigExtensionType_type") :
            getString("_UI_FacesConfigExtensionType_type") + " " + label;
    }
