 ...
 *******************************************************************************/
package org.eclipse.jst.jsf.ui;
 ...
 * @since 1.0
 */
public class StructuredTextViewerConfigurationJSF extends StructuredTextViewerConfiguration {
	/*
	...
	/**
	 * Create new instance of StructuredTextViewerConfigurationJSF
	 */
	public StructuredTextViewerConfigurationJSF() {
	...
	protected IPreferenceStore[] createPreferenceStores() {
		...
		preferenceStores.add(JSFUiPlugin.getDefault().getPreferenceStore());
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		if (assistant instanceof ContentAssistant) {
			((ContentAssistant) assistant).enableAutoInsert(JSFUiPlugin.getDefault().getPreferenceStore().getBoolean(JSPUIPreferenceNames.INSERT_SINGLE_SUGGESTION));
		}
		return assistant;
	}
